...
public class MascotaFragment extends Fragment {
    ...
    public void inicializaListaMascotas(){
        ...
        fotosMascota.add(new Mascota(R.drawable.labrador1,"Mimascota", 3));
        fotosMascota.add(new Mascota(R.drawable.labrador2, "Mimascota",2));
        fotosMascota.add(new Mascota(R.drawable.labrador3, "Mimascota",4));
